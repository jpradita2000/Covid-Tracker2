...
public class Ventana extends javax.swing.JFrame {
   ...
   // CovidTracker cvt;
    ...
    public void ovaloSegunEstado(Vertice temporal,Graphics g , int x , int y) {
        
        if (temporal.isInfectado()) {
    ...
    public void dibujarGrafo(){
        ...
        Vertice temporal = cvt.getPtr();
        while(temporal!=null){
            if(reguladorDibujo%3==0){
                x=x+20;y=60;
                ovaloSegunEstado(temporal,g,x,y);
            }else{
                ovaloSegunEstado(temporal,g,x,y);
                y+=60;
            }
            
//            g.drawOval(reguladorEjex, this.jPanel1.getHeight()*1/reguladorEjey, 30,30);
//            reguladorEjey--;
            Arista temporal2 = temporal.getAristas();
            while(temporal2!=null){
                temporal2 = (Arista)temporal2.getLink();
            }
            
            temporal=(Vertice) temporal.getLink();
        }
    }
